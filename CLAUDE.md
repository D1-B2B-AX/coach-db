...
MVP 1차 구현 완료. Supabase 연결 + 구글시트 동기화 정상 동작 (코치 272명, 과정 168개).
...
Next.js 16 (App Router) + Tailwind CSS v4 + Supabase (Postgres + Auth) + Google Drive API + xlsx

## 핵심 컨벤션

- 한국어 UI, 코드는 영어
- Supabase RLS로 접근 제어 (@day1company.co.kr 도메인 제한)
